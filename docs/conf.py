...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''geotools''')])
...
project = u'''geotools'''
copyright = u'''2017, (Author : Vangelis Zacharis)'''
...
version = geotools.__version__
# The full version, including alpha/beta/rc tags.
release = geotools.__version__
...
latex_documents = [
    ('index', '''geotools.tex''',
     u'''geotools Documentation''',
     u'''Vangelis Zacharis''', 'manual'),
]
